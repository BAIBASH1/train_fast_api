...
Modules:
    - dao: Contains the BookingDAO class with asynchronous methods for managing bookings
     in the database.
...
The package facilitates the full lifecycle of booking management from database operations
to API interaction.
"""
