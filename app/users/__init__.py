...
It provides routes, data access objects (DAO), models, and schemas necessary to manage users
in the system.

Modules:
    - auth: Provides functions for creating access tokens, password hashing and verification, and
     user authentication.
    - dao: Contains the `UsersDAO` class for interacting with the database to retrieve and store
     user data.
    - dependencies: Provides dependencies for extracting and verifying JWT tokens,
